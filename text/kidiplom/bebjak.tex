...
Na rozdiel od vláken je prepínanie medzi gorutinami rýchlejšie približne o 1,242\mu s.\cite{cox2017}
...
Go používa plánovač \uv{M:N} a model súbežnosti fork-join.\cite{cox2017} Teda na \uv{M} vláknach sa vykonáva \uv{N} goroutine. Goroutine
sú mapované na tieto vlákna a runtime sa stará o ich rozdelenie a efektívne vykonávanie. Podľa modelu môže program vytvoriť novú
goroutine, ktorá sa vykonáva súbežne s rodičovským kódom. Neskôr sa tieto vetvy spoja v mieste nazývanom join point.
